...
public enum PreparationErrorCode implements ErrorCode {
  ...
  DO_NOT_GENERATING(HttpStatus.BAD_REQUEST, "PREP-B002", "READY 상태에서만 질문 생성 시작이 가능합니다."),
  DO_NOT_GENERATED(HttpStatus.BAD_REQUEST, "PREP-B003", "질문 생성 중일 때만 생성 완료 처리를 할 수 있습니다."),
  DO_NOT_FAILED(HttpStatus.BAD_REQUEST, "PREP-B004", "질문 생성 중일 때만 실패 처리를 할 수 있습니다."),
  INVALID_FILE_EXTENSION(HttpStatus.BAD_REQUEST, "PREP-B005", "PDF 파일만 업로드할 수 있습니다."),
  INVALID_CONTENT_TYPE(
      HttpStatus.BAD_REQUEST, "PREP-B006", "contentType은 application/pdf 이어야 합니다."),
  FILE_SIZE_EXCEEDED(HttpStatus.BAD_REQUEST, "PREP-B007", "파일 크기가 허용 용량을 초과했습니다."),
  EMPTY_FILE_REGISTER_REQUEST(HttpStatus.BAD_REQUEST, "PREP-B008", "등록할 파일이 최소 1개 이상 필요합니다."),
  DUPLICATE_FILE_TYPE_IN_REQUEST(
      HttpStatus.BAD_REQUEST, "PREP-B009", "한 요청 안에서 파일 타입은 중복될 수 없습니다."),
